...
def execute(filters=None):
	...
	for i in res:
		if i.get("party_type")=="Customer":
			a = frappe.get_doc('Customer',{'name':i.get('party')})
			i.update({'city':a.city})
			i.update({'territory':a.territory})
			i.update({'salesperson':a.sales_person})
		else:
			pass
